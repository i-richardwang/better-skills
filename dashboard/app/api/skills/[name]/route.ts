  ...
  try {
    ...
    const iterations = await db
      .select({
        ...
        baseline_resolved: schema.iterations.baselineResolved,
        current_pass_rate_mean: schema.iterations.currentPassRateMean,
        current_pass_rate_stddev: schema.iterations.currentPassRateStddev,
        ...
        current_tokens_mean: schema.iterations.currentTokensMean,
        current_time_seconds_mean: schema.iterations.currentTimeSecondsMean,
